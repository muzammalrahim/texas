...
def get_case(case_info):
    """
    # Get case data such as case event and Trial Court Information , etc..
    # This section has many traffic to get all case data.
    # So have to use proxy and user-agent rotating.
    :param case_info: case info contains case number and bar card number
    :return: Case data array
    """
...
def update_case(case_info):
    """
    # Update all case data using case info.
    # In this section have to use proxy and user-rotating too
    :param case_info:
    :return:
    """
    header = {
